...
export default function Intro() {
  return (
    <div className='flex items-center justify-center flex-col text-center pt-20 pb-6 dark:bg-stone-800 dark:text-white'>
      <img src='/profile-pic.jpg' className='rounded-full w-36 h-36' />
      ...
      <p className='text-stone-700 text-md max-w-xl mb-6 font-bold'>
        ...
        ventures on this blog and share them with you. Here's to the future!
      </p>
    </div>
  );
}
